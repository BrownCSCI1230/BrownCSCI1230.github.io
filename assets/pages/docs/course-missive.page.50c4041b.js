...
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"HTA:"}),e.exports.jsx("br",{}),`
Apoorva Talwalkar (`,e.exports.jsx(s.code,{children:"atalwalk"}),")"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"UTAs:"}),e.exports.jsx("br",{}),`
Alesandro Gopal (`,e.exports.jsx(s.code,{children:"aggopal"}),`),
Jason Heflinger (`,e.exports.jsx(s.code,{children:"jhefling"}),`),
Bailing Hou (`,e.exports.jsx(s.code,{children:"bhou14"}),`),
Alex Jiang (`,e.exports.jsx(s.code,{children:"ajiang38"}),`),
Muhamed Ka (`,e.exports.jsx(s.code,{children:"mka1"}),`),
Sue An Park(`,e.exports.jsx(s.code,{children:"spark324"}),")"]}),`
...
`,e.exports.jsxs(s.p,{children:["The professor also holds office hours each week; you can book an appointment with him via ",e.exports.jsx(s.a,{href:"https://calendar.app.google/3D3U9rDhFW5YvSEJA",target:"_blank",rel:"noopener noreferrer",children:"this link"}),"."]}),`
...
`,e.exports.jsx(s.div,{className:"warning-callout callout",children:e.exports.jsxs(s.p,{children:["Before we can grade any of your assignments, you must complete our collaboration policy agreement in the ",e.exports.jsx(s.a,{href:"https://forms.gle/p2prT4YNiY3EUCr79",target:"_blank",rel:"noopener noreferrer",children:"getting started form"}),". If you do not do so, you cannot pass this course."]})}),`
...
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.strong,{children:"Projects:"})," For each day past the deadline that a project submission is late, the maximum possible score you can receive for that project decreases by 10%, down to a minimum of 50% of the total points. For example, if you submit a project 3 days late, the maximum possible score you can receive is 70% of the total points. If you submit a project 5 or more days late, the maximum possible score you can receive is 50% of the total points. Extra credit can still go above this maximum possible score (just as it would for projects submitted on time).If you are 25 hours late in submitting, that's a 20% penalty, even though you hand in during the first hour of that 'extra day.'"]}),`
