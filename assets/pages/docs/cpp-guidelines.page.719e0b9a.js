...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:["std::",e.exports.jsx(s.span,{className:"pl-c1",children:"uint8_t"}),"[] arr ",e.exports.jsx(s.span,{className:"pl-c",children:"// bad"}),`\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:["*(ptr + ",e.exports.jsx(s.span,{className:"pl-c1",children:"1"}),") ",e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-k",children:"auto"})," x1 = Type{}; ",e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-k",children:"auto"})," y = Type(); ",e.exports.jsx(s.span,{className:"pl-c",children:"// bad"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:["Type z{}; ",e.exports.jsx(s.span,{className:"pl-c",children:"// ugly, but okay"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:["Type ",e.exports.jsx(s.span,{className:"pl-en",children:"w"}),"(); ",e.exports.jsx(s.span,{className:"pl-c",children:"// very bad: this does not create a variable w."}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:["          ",e.exports.jsx(s.span,{className:"pl-c",children:"// it declares a function w() which returns an instance of Type."}),`\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-k",children:"auto"}),` x = ComplicatedThing{param1, param2, param3};\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-k",children:"for"})," (",e.exports.jsx(s.span,{className:"pl-k",children:"auto"}),`& x : container)\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:["  ",e.exports.jsx(s.span,{className:"pl-c",children:"// something involving x"}),`\r
`]}),e.exports.jsx(s.span,{className:"code-line",children:`\r
`}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// bad, unless you need i elsewhere in the loop"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-k",children:"for"})," (",e.exports.jsx(s.span,{className:"pl-k",children:"auto"})," i = ",e.exports.jsx(s.span,{className:"pl-c1",children:"0"}),`; i < container.size(); ++i)\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// bad: not very readable"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:["std::vector<std::array<SuperLongTypeName, ",e.exports.jsx(s.span,{className:"pl-c1",children:"123"}),`>> variable\r
`]}),e.exports.jsx(s.span,{className:"code-line",children:`\r
`}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-k",children:"using"})," InnerType = std::array<SuperLongTypeName, ",e.exports.jsx(s.span,{className:"pl-c1",children:"123"}),`>;\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-k",children:"using"}),` ContainerType = std::vector<InnerType>;\r
...
`,e.exports.jsx(s.pre,{children:e.exports.jsxs(s.code,{className:"language-text code-highlight",children:[e.exports.jsx(s.span,{className:"code-line",children:`obj: object\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`col: column\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`mat: matrix\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`vec: vector\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`vert: vertex\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-en",children:"printVAO"}),"(); ",e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:["std::tuple<",e.exports.jsx(s.span,{className:"pl-k",children:"int"}),", ",e.exports.jsx(s.span,{className:"pl-k",children:"int"}),"> ",e.exports.jsx(s.span,{className:"pl-en",children:"countLeafAndNonleafNodes"}),`(MyTreeType& ast);\r
`]}),e.exports.jsx(s.span,{className:"code-line",children:`\r
`}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// bad: no one will understand why there are two return values"}),`\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// good"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// Returns the number of leaf and non-leaf nodes in a given MyTreeType"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:["std::tuple<",e.exports.jsx(s.span,{className:"pl-k",children:"int"}),", ",e.exports.jsx(s.span,{className:"pl-k",children:"int"}),"> ",e.exports.jsx(s.span,{className:"pl-en",children:"countLeafAndNonleafNodes"}),`(MyTreeType& ast);\r
`]}),e.exports.jsx(s.span,{className:"code-line",children:`\r
`}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// bad: implementation detail is irrelevant, and comment is getting too long"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// Uses DFS to iterate through nodes of given MyTreeType ast, then returns a"}),`\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-c",children:"// tuple containing the count of leaf nodes and the count of non-leaf nodes,"}),`\r
