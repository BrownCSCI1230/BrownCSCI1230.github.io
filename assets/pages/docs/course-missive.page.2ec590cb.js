...
Anastasio Ortiz (`,e.exports.jsx(s.code,{children:"aortiz18"}),`),
...
Evan Mickelson (`,e.exports.jsx(s.code,{children:"emickels"}),`),
Stewart Morris (`,e.exports.jsx(s.code,{children:"smorri21"}),`),
Praccho Muna-McQuay (`,e.exports.jsx(s.code,{children:"pmunamcq"}),`),
Luke Riley (`,e.exports.jsx(s.code,{children:"lriley2"}),`),
Krishi Saripalli (`,e.exports.jsx(s.code,{children:"ksaripal"}),`),
Jean Yoo (`,e.exports.jsx(s.code,{children:"syoo28"}),`),
Faisal Zaghloul (`,e.exports.jsx(s.code,{children:"fzaghlou"}),`),
Sophie Zhang (`,e.exports.jsx(s.code,{children:"szhang257"}),")"]}),`
...
`,e.exports.jsx(s.p,{children:"Lectures are held Tues & Thurs 10:30am - 11:50am in Smith-Buonanno Hall 106. Recordings will be made available online."}),`
`,e.exports.jsx(s.h3,{id:"ed",children:e.exports.jsx(s.a,{href:"#ed",children:"Ed"})}),`
`,e.exports.jsxs(s.p,{children:["Feel free to ask questions on our ",e.exports.jsx(s.a,{href:"https://edstem.org/us/courses/65180",target:"_blank",rel:"noopener noreferrer",children:"Ed discussion page"})," (",e.exports.jsx(s.a,{href:"https://edstem.org/us/join/6utBgE",target:"_blank",rel:"noopener noreferrer",children:"sign-up link"}),")!"]}),`
`,e.exports.jsx(s.p,{children:"Our TAs monitor Ed and answer questions during Ed hours throughout the week; these can be found on the course calendar. Outside of these times, you should not expect a prompt response from a TA. In particular, please note that we do not have Ed hours from 10pm - 6am or on weekends."}),`
...
`,e.exports.jsx(s.p,{children:"Our TAs hold regularly-scheduled TA hours, during which you may ask questions about the course and assignments; these can also be found on the course calendar."}),`
...
`,e.exports.jsx(s.p,{children:"The professor also holds office hours each week."}),`
...
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.strong,{children:"CSCI 1230 S02:"}),' This is the alternate "online" section of the course. This section is exclusively for students who are not on campus (e.g. studying abroad, remote masters students). Students enrolled in this section (and ',e.exports.jsx(s.strong,{children:"only"})," students enrolled in this section) will be permitted to do lab checkoffs, mentor meetings, and office hours remotely."]}),`
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.strong,{children:"CSCI 2230:"})," This course is for graduate students who wish to earn 2000-level credit. Graduate students enrolled in this course attend the same lectures and complete the same assignments as students in CSCI 1230; however, they will be expected to implement some extra features for each assignment. If you are not currently working towards a graduate degree, you cannot enroll in this course."]}),`
...
`,e.exports.jsxs(s.p,{children:["The only official ",e.exports.jsx(s.strong,{children:"course"})," prerequisite for CSCI 1230 is to have completed a CS intro sequence, culminating in CSCI 0160, 0180, 0190, or 0200."]}),`
...
`,e.exports.jsx(s.li,{children:"Determining object visibility by casting rays from a camera into a scene, and"}),`
`,e.exports.jsx(s.li,{children:"Understanding mathematical models for calculating the amount of light reflected from an object in a scene."}),`
`]}),`
`]}),`
...
`,e.exports.jsx(s.li,{children:"Simulating interactive first-person camera movement via transformation matrices,"}),`
`,e.exports.jsx(s.li,{children:"Writing shaders in the GLSL shading language for vertex transformation, per-pixel lighting calculation, and"}),`
`,e.exports.jsx(s.li,{children:"Utilizing frame buffers to implement full-screen post-processing effects."}),`
`]}),`
`]}),`
`]}),`
...
`,e.exports.jsx(s.p,{children:`To get you started thinking mathematically and algorithmically about each of the 6 (non-final) projects, we have discussion sections for groups of students to work through a set of conceptual questions under the supervision of the TAs.
...
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"Project 2: Filter"}),": 10%"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"Project 3: Intersect"}),": 12%"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"Project 4: Illuminate"}),": 13%"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"Project 5: Lights, Camera"}),": 12%"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"Project 6: Action!"}),": 13%"]}),`
`,e.exports.jsxs(s.li,{children:[e.exports.jsx(s.strong,{children:"Final Project"}),": 15%"]}),`
`]}),`
`]}),`
`]}),`
...
`,e.exports.jsxs(s.p,{children:[e.exports.jsx(s.strong,{children:"Projects:"})," Each day a project is turned in late will be penalized 10% of the possible total points. (If you are 25 hours late in handing in, that's a 20%, even though you hand in during the first hour of that 'extra day')."]}),`
`,e.exports.jsxs(s.p,{children:["Every student has ",e.exports.jsx(s.strong,{children:"five late days"})," that can each be used to waive a day that a project was turned in late. Filling out our mid-semester course feedback survey also grants you one extra late day. These late days will automatically be applied optimally (to maximize your grade) at the end of the semester. ",e.exports.jsx(s.strong,{children:e.exports.jsx(s.em,{children:"You may not use any late days at all on any part of the final project."})})]}),`
...
`,e.exports.jsx(s.h2,{id:"accommodations",children:e.exports.jsx(s.a,{href:"#accommodations",children:"Accommodations"})}),`
`,e.exports.jsxs(s.p,{children:["Brown University is committed to full inclusion of all students. Please inform Daniel if you have a disability or other condition that might require accommodations or modification of any of these course procedures. You may email Daniel, come to office hours, or speak with him after class, and your confidentiality is respected. We will do whatever we can to support accommodations recommended by SEAS. For more information contact Student and Employee Accessibility Services (",e.exports.jsx(s.a,{href:"https://www.brown.edu/campus-life/support/accessibility-services/",target:"_blank",rel:"noopener noreferrer",children:"SEAS"}),") at 401-863-9588 or ",e.exports.jsx(s.a,{href:"mailto:SEAS@brown.edu",children:"SEAS@brown.edu"}),". Students in need of short-term academic advice or support can contact one of the deans in the Dean of the College office."]}),`
`,e.exports.jsx(s.h2,{id:"mental-health",children:e.exports.jsx(s.a,{href:"#mental-health",children:"Mental Health"})}),`
`,e.exports.jsxs(s.p,{children:["Being a student can be very stressful. If you feel you are under too much pressure or there are psychological issues that are keeping you from performing well at Brown, we encourage you to contact Brown's Counseling and Psychological Services ",e.exports.jsx(s.a,{href:"https://www.brown.edu/campus-life/support/counseling-and-psychological-services/",target:"_blank",rel:"noopener noreferrer",children:"CAPS"}),". They provide confidential counseling and can provide notes supporting extensions on assignments for health reasons."]}),`
