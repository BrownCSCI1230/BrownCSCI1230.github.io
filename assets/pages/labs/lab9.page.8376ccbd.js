...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/State_Machine.png",alt:"TODO"}],figNumber:3,targetWidth:"100%",children:e.exports.jsxs(t.p,{children:["Visualization of the OpenGL State Machine. Here, we show how using the state setting function ",e.exports.jsx(t.code,{children:"glClearColor"}),`
changes the state of the context, and how using the state using function `,e.exports.jsx(t.code,{children:"glClear"}),` uses the state of the
context to clear the screen to a particular color.`]})}),`
...
`,e.exports.jsx(t.p,{children:'Submit your Github repo for this lab to the "Lab 9: VBOs & VAOs" assignment on Gradescope, then get checked off by a TA during hours.'}),`
