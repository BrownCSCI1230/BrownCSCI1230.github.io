...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["Add two input parameters to the ",e.exports.jsx(t.code,{children:"checkOpenGLErrors"})," function, the first being a ",e.exports.jsx(t.code,{children:"const char*"})," for the file name, and the second being an ",e.exports.jsx(t.code,{children:"int"})," for the line number. Edit the print statement to include this information to make the debug statements more descriptive (Include the file name and line number)."]})}),`
...
`,e.exports.jsx(t.pre,{className:"language-cpp",children:e.exports.jsx(t.code,{className:"language-cpp code-highlight",children:e.exports.jsxs(t.span,{className:"code-line",children:[e.exports.jsx(t.span,{className:"pl-en",children:"Debug::checkOpenGLErrors"}),`(__FILE__, __LINE__);
`]})})}),`
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["After defining our ",e.exports.jsx(t.code,{children:"checkOpenGLErrors"})," function, add the following preprocessor directive:"]}),e.exports.jsx(t.pre,{className:"language-cpp",children:e.exports.jsx(t.code,{className:"language-cpp code-highlight",children:e.exports.jsxs(t.span,{className:"code-line",children:["#",e.exports.jsx(t.span,{className:"pl-k",children:"define"})," ",e.exports.jsx(t.span,{className:"pl-en",children:"checkOpenGLErrors"}),`() checkOpenGLErrors(__FILE__, __LINE__)
`]})})})]}),`
...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/State_Machine.png",alt:"TODO"}],figNumber:3,targetWidth:"100%",figCaption:"Visualization of the OpenGL State Machine. Here, we show how using the state setting function `glClearColor`` changes the state of the context, and how using the state using function `glClear` uses the state of the context to clear the screen to a particular color."}),`
...
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"target"}),":"]})," This is the same argument seen in glBindBuffer."]}),`
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"size"}),":"]})," the size, in ",e.exports.jsx(t.strong,{children:"bytes"}),", of the input data array. Something like ",e.exports.jsx(t.code,{children:"sizeof(float) * data.size()"}),"."]}),`
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"initializeGL()"}),", construct a ",e.exports.jsx(t.code,{children:"std::vector"}),` containing your three triangle points in a contiguous
series of floats.`]})}),`
...
in our vector (e.g. `,e.exports.jsx(t.code,{children:"sizeof(float)"}),")."]}),`
...
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"arrays"}),":"]})," the pointer this function will fill in with an ID for the generated array. Similarly to `glGenBuffers``, you can also fill in an array or segment of continuous memory with pointers to multiple vertex array objects."]}),`
`]})]}),`
...
we use to identify each attribute. We pick this value ourselves; in the next lab, Shaders,
you will see how we use this index when doing shader programming. In this lab, because we have written
...
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"type"}),":"]})," the type of variable used for each component in the attribute. For floats, this would be ",e.exports.jsx(t.code,{children:"GL_FLOAT"}),"."]}),`
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"normalized"}),":"]})," this is a bit complicated and has to do with types; for now, just use ",e.exports.jsx(t.code,{children:"GL_FALSE"}),"."]}),`
