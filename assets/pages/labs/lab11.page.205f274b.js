...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"InitializeGL"}),", generate an empty texture, ",e.exports.jsx(t.code,{children:"m_fbo_texture"}),` and bind it to texture slot 1.
This will be used to store our color buffer! To generate an empty texture, when
calling `,e.exports.jsx(t.code,{children:"glTexImage2D"}),`, pass in a nullptr for the data. Be sure to set the same minify and
magnify parameters as well as return to default state by unbinding our texture once we have
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["Before exiting ",e.exports.jsx(t.code,{children:"InitializeGL"}),`, make sure to return to default state by unbinding our
