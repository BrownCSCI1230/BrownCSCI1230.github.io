...
`,e.exports.jsx(t.code,{children:"GL_TEXTURE_2D"}),"."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"pname"})," :"]})," This is an enum for the parameter we wish to set."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"param"})," :"]}),` This is the value we wish to set for our chosen parameter. See the documentation
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"IntializeGL"}),`, set the uniform value for your sampler2D you created in your fragment shader
...
of program 0 afterwards.`]}),e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"PaintGL"}),", before calling ",e.exports.jsx(t.code,{children:"glDrawArrays"}),", be sure to bind our ",e.exports.jsx(t.code,{children:"m_kitten_texture"}),` to
texture slot 0.`]})]}),`
...
`,e.exports.jsx(r,{images:[{src:"/labs/lab9/openglcoordinates.png",alt:"TODO"}],figNumber:2,targetWidth:"95%",figCaption:"OpenGL Coordinate System"}),`
...
`,e.exports.jsx(r,{images:[{src:"/labs/lab11/UVCoordinates.png",alt:"TODO"}],figNumber:3,targetWidth:"95%",figCaption:"UV Coordinates in OpenGL"}),`
...
`,e.exports.jsxs(t.p,{children:[`Now we want to set our fragment color to be our texture at our pre-selected UV coordinates.
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"texture.frag"}),`, set the fragment color based on the texture color at the fragment's
UV coordinate.`]})}),`
...
`,e.exports.jsx(r,{images:[{src:"/labs/lab11/fboattachments.png",alt:"TODO"}],figNumber:4,targetWidth:"80%",figCaption:"FBO Attachments"}),`
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"InitializeGL"}),", generate an empty texture, ",e.exports.jsx(t.code,{children:"m_fbo_texture"}),` and bind it to texture slot 1.
This will be used to store our color buffer.`]}),e.exports.jsxs(t.blockquote,{children:[`
...
unbinding our texture once we haveset all its parameters.`]}),`
`]})]}),`
`,e.exports.jsx(t.p,{children:"Next let's use instead a Renderbuffer to store our depth and stencil attachments."}),`
`,e.exports.jsx("details",{children:e.exports.jsxs(t.p,{children:[e.exports.jsx("summary",{children:"Why not use another Texture?"}),`
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["Generate a renderbuffer, bind it, then set its configuration using ",e.exports.jsx(t.code,{children:"glRenderbufferStorage"}),`. You
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"InitializeGL"}),` after binding our FBO, attach both the color and depth/stencil attachemnts.
...
`,e.exports.jsx(t.p,{children:e.exports.jsx(t.a,{href:"https://registry.khronos.org/OpenGL-Refpages/es3.1/html/glFramebufferRenderbuffer.xhtml",children:e.exports.jsx(t.strong,{children:"void glFramebufferRenderbuffer(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);"})})}),`
`]})}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"target"})," :"]}),` This indicates the type of framebuffer we are working with. Just like in
`,e.exports.jsx(t.code,{children:"glBindFramebuffer"}),", use ",e.exports.jsx(t.code,{children:"GL_FRAMEBUFFER"}),"."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"attachment"})," :"]}),` This is the specific attachment we wish to add, since we are attaching
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["Return to default state by unbinding our FBO. Do this by binding the FBO with id: ",e.exports.jsx(t.code,{children:"DEFAULT_FBO"}),`.
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["After drawing for the second time in ",e.exports.jsx(t.code,{children:"PaintGL"}),`, unbind our VAO, texture, and make sure to
unbind our current shader program as well.`]})}),`
`,e.exports.jsxs(t.p,{children:[`IMPORTANT STILL WORKING ON FIX:
If you run the program now, you `,e.exports.jsx(t.strong,{children:"still"}),` may see a black screen. Why is this?
...
fbo will be of value 2. Try replacing `,e.exports.jsx(t.code,{children:"glBindFramebuffer(GL_FRAMEBUFFER, 0)"}),` with
`,e.exports.jsx(t.code,{children:"glBindFramebuffer(GL_FRAMEBUFFER, 2)"}),`. If nothing still shows up, please let a TA
know.`]}),`
...
`,e.exports.jsx(t.code,{children:"size().width()"})," instead."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"height"})," :"]}),` Similarly to width, this specifies the height of the FBO we are drawing to.
