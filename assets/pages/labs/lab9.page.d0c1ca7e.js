...
`,e.exports.jsxs(t.p,{children:["For this section, you will be working in ",e.exports.jsx(t.code,{children:"debug.h"}),`. However, for the rest of the assignment,\r
you will be working in `,e.exports.jsx(t.code,{children:"glRenderer.cpp"}),"."]}),`
`]}),`
`,e.exports.jsx(t.p,{children:`Any time OpenGL is incorrectly used, instead of crashing the program, you\r
may just encounter a blank screen with no error messages. This may be difficult to debug,\r
but luckily, OpenGL does some work behind the scenes for us.`}),`
`,e.exports.jsx(t.p,{children:`Each time OpenGL detects a function has been used incorrectly, it will set an error flag\r
behind the scenes. But how do we know what error flags are currently set? In the previous section,\r
you looked at the documentation for a function called glGetError. This function when called\r
will return one of these stored error flags and clear it from storage. Unfortunately, the\r
order in which flags are returned is random, so the best way to overcome this is if\r
you encounter errors, check the flags, and check them often.`}),`
`,e.exports.jsxs(t.p,{children:[`In addition to this, each time you check for errors, it is important to call glGetError in\r
a loop until it returns GL_NO_ERROR indicating all errors have been cleared. In `,e.exports.jsx(t.code,{children:"debug.h"}),`\r
we have provided you the following function which does this:`]}),`
`,e.exports.jsx(t.pre,{children:e.exports.jsxs(t.code,{className:"code-highlight",children:[e.exports.jsx(t.span,{className:"code-line",children:`inline void checkOpenGLErrors(){\r
`}),e.exports.jsx(t.span,{className:"code-line",children:`  GLenum error = glGetError();\r
`}),e.exports.jsx(t.span,{className:"code-line",children:`  while(error != GL_NO_ERROR){\r
`}),e.exports.jsx(t.span,{className:"code-line",children:`    std::cout<<error<<std::endl;\r
`}),e.exports.jsx(t.span,{className:"code-line",children:`    error = glGetError();\r
`}),e.exports.jsx(t.span,{className:"code-line",children:`  }\r
`}),e.exports.jsx(t.span,{className:"code-line",children:`}
`})]})}),`
`,e.exports.jsxs(t.blockquote,{children:[`
`,e.exports.jsxs(t.p,{children:[`Feel free to use this header file in your OpenGL projects. You are not expected to understand\r
`,e.exports.jsx(t.strong,{children:"namespace"})," and ",e.exports.jsx(t.strong,{children:"inline"}),`, but just know to use this function in another file, be sure to\r
include the header file and call the function as: `,e.exports.jsx(t.code,{children:"Debug::checkOpenGLErrors()"}),"."]}),`
`]}),`
`,e.exports.jsx(t.p,{children:`While this is useful, sometimes if we are calling this multiple times in different locations\r
throught our program, it can be difficult to determine which call is reading in an error.`}),`
`,e.exports.jsx(t.p,{children:`How about we change our function to take in a line number and file name so we can use that\r
when we print our errors:`}),`
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["Add two input parameters to the ",e.exports.jsx(t.code,{children:"checkOpenGLErrors"}),` function, one being a\r
const char* for the file name, and another being an int for the line number. Edit the print\r
statement to include this information to make the debug statements more descriptive.`]})}),`
`,e.exports.jsx(t.p,{children:`This is great, but a pain to input the file and line every time we call the function.\r
Luckily, C++ provides preprocessor macros: __LINE__ and __FILE__ which get replaced at\r
...
`})})}),`
`,e.exports.jsxs(t.p,{children:["We can make this even simpler by using something called a ",e.exports.jsx(t.strong,{children:"preprocessor directive"}),`.\r
A preprocessor directive is indicated by the use of a hash symbol in the beginning. As a matter\r
...
`})})}),`
`,e.exports.jsx(t.p,{children:`The way it works is that the preproccessor will replace every instance of the identifier in the\r
...
`})})})]}),`
`,e.exports.jsx(t.p,{children:`Now we can call the function with no arguments, just as we did originally but the preprocessor\r
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["Generate a single VBO in ",e.exports.jsx(t.code,{children:"InitializeGL"})," and store its id in ",e.exports.jsx(t.code,{children:"m_vbo"}),`. You may find the\r
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"InitializeGL"}),`, bind your previously created VBO. You may find the following function\r
...
`,e.exports.jsxs(t.p,{children:[`Lets take a closer look at the data parameter. The function expects a pointer to an input data array,\r
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"InitializeGL"}),", generate a single VAO and store its id in ",e.exports.jsx(t.code,{children:"m_vao"}),`. You may find the\r
following function useful:`]}),e.exports.jsxs(t.div,{className:"success-callout callout",children:[e.exports.jsx("p",{style:{textAlign:"center"},children:e.exports.jsxs(t.blockquote,{children:[`
...
does not refer to an index into our data vector. Rather, this is just some unique unsigned integer\r
we use to identify each attribute. We pick this value ourselves and in the next lab, Shaders,\r
you will see how we use this index when doing shader programming! Because we have written\r
the shaders for you, we have assigned `,e.exports.jsx(t.strong,{children:"position to have index 0"})," and ",e.exports.jsx(t.strong,{children:`color to have an\r
index of 1`}),"."]})]}),`
...
to store our data and objects. This memory is `,e.exports.jsx(t.strong,{children:"not"}),`\r
