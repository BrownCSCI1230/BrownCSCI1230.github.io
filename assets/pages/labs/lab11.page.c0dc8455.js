...
`,e.exports.jsx(t.p,{children:`Before we configure our FBO, we need to generate containers for its attachments. As stated\r
previously, these can either be Textures or Renderbuffers. Let's try using a Texture in place\r
of our color attachment.`}),`
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"InitializeGL"}),", generate an empty texture, ",e.exports.jsx(t.code,{children:"m_fbo_texture"}),` and bind it to texture slot 1.\r
This will be used to store our color buffer.`]}),e.exports.jsxs(t.blockquote,{children:[`
`,e.exports.jsxs(t.p,{children:["To generate an empty texture, when calling ",e.exports.jsx(t.code,{children:"glTexImage2D"}),`, pass in a nullptr for the data.\r
Be sure to set the same minify and magnify parameters as well as return to default state by\r
...
`,e.exports.jsx("details",{children:e.exports.jsxs(t.p,{children:[e.exports.jsx("summary",{children:"Why not use another Texture?"}),`\r
If you recall, as opposed to Textures, Renderbuffers can only be written to. This allows\r
for OpenGL to make some behind-the-scenes optimizations. For depth information, we\r
do not need to sample it like we do a texture. Later on, we will redraw our FBO by\r
using its color attachment texture just how we did the `,e.exports.jsx(t.code,{children:"m_kitten_texture"}),` to draw back\r
to the screen. But depth calculations are all self contained during the render process\r
and we do not need to sample it for our purposes.`]})}),`
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["Generate a renderbuffer, bind it, then set its configuration using ",e.exports.jsx(t.code,{children:"glRenderbufferStorage"}),`. You\r
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["Return to default state by unbinding our FBO. Do this by binding the FBO with id: ",e.exports.jsx(t.code,{children:"DEFAULT_FBO"}),`.\r
