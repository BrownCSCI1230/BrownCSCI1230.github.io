...
`,e.exports.jsx(s.li,{children:"Learn to use triangle meshes to approximate an object's surface."}),`
`,e.exports.jsx(s.li,{children:"Implement Cube and Sphere meshes with different levels of approximation"}),`
`]}),`
...
`,e.exports.jsxs(s.p,{children:["Recall that the tessellation level determines the number of triangles used in a trimesh. As shown below, to represent a collection of triangles, we just append the additional triangle information onto the back of the list. In our case, this list is still represented as ",e.exports.jsx(s.code,{children:"std::vector<float> m_vertexData"}),"."]}),`
...
`,e.exports.jsxs(s.p,{children:["Each shape will also have an ",e.exports.jsx(s.code,{children:"int m_param1"})," and/or ",e.exports.jsx(s.code,{children:"int m_param2"}),". These correspond to the parameter sliders that you'll see in the UI when you start up the program."]}),`
...
`,e.exports.jsxs(s.p,{children:[`Remember that the Cube has a radius of 0.5 and lies in the bounds [-0.5, 0.5] on all axes.
