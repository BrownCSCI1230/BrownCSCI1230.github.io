...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/VBO_VAO_Overview.png",alt:"TODO"}],figNumber:1,targetWidth:"95%",figCaption:"Visualization of VBOs and VAOs"}),`
...
a loop until it returns GL_NO_ERROR indicating all errors have been cleared. In `,e.exports.jsx(t.code,{children:"debug.h"}),`
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["Add two input parameters to the ",e.exports.jsx(t.code,{children:"checkOpenGLErrors"}),` function, one being a
const char* for the file name, and another being an int for the line number. Edit the print
...
of fact, you may already be familiar with the #include preprocessor directive.`]}),`
...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/State_Machine.png",alt:"TODO"}],figNumber:2,targetWidth:"95%",figCaption:"Visualization of OpenGL State Machine"}),`
`,e.exports.jsxs(t.blockquote,{children:[`
...
attribute. For floats, this would be GL_FLOAT.`]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"normalized"})," :"]})," This is a bit complicated to do with types, but for now use GL_FALSE."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"stride"})," :"]}),` This indicates the size in bytes between two vertices.
...
`,e.exports.jsx(t.code,{children:"reinterpret_cast<void*>(offset value)"})]}),e.exports.jsx(s,{images:[{src:"/labs/lab9/Stride_Offset_White_Background.png",alt:"TODO"}],figNumber:4,targetWidth:"95%",figCaption:"Visualization of Vertex Attribute layouts"})]}),`
`,e.exports.jsxs(t.blockquote,{children:[`
...
in figure 5 below!`}),`
`]}),`
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/VAOMultiple.png",alt:"TODO"}],figNumber:5,targetWidth:"80%",figCaption:"VAOs w/ Single and Multiple VBOs"}),`
...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/FinalTriangle.png",alt:"TODO"}],figNumber:6,targetWidth:"95%",figCaption:"Colorful Triangle"}),`
...
`,e.exports.jsxs(t.p,{children:["For now we will use two, ",e.exports.jsx(t.a,{href:"https://registry.khronos.org/OpenGL-Refpages/es3.1/html/glDeleteBuffers.xhtml",children:"glDeleteBuffers"}),`
which applies to VBOs, and `,e.exports.jsx(t.a,{href:"https://registry.khronos.org/OpenGL-Refpages/es3.1/html/glDeleteVertexArrays.xhtml",children:"glDeleteVertexArrays"}),`
