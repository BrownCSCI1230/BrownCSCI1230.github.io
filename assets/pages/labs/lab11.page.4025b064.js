...
`]}),e.exports.jsxs("details",{children:[" ",e.exports.jsx("summary",{children:e.exports.jsxs(t.p,{children:["What is the ",e.exports.jsx(t.code,{children:"m_devicePixelRatio"})," variable ",e.exports.jsx(t.code,{children:"m_fbo_width"})," and ",e.exports.jsx(t.code,{children:"m_fbo_height"})," are initialized with?"]})}),e.exports.jsxs(t.p,{children:[`For high density displays such as retina displays on many Mac computers, there is a discrepancy
...
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"width"})," :"]})," This is the width of our FBO we wish to draw to. For our ",e.exports.jsx(t.strong,{children:"FBO"}),", we can use m_fbo_width, which should match what we used to generate our FBO attachments. For our ",e.exports.jsx(t.strong,{children:"screen"}),", we can use ",e.exports.jsx(t.code,{children:"size().width() * m_devicePixelRatio"})," instead."]}),`
`,e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"height"})," :"]})," Similarly to width, this specifies the height of the FBO we are drawing to. For our ",e.exports.jsx(t.strong,{children:"FBO"}),", we can use m_fbo_height, which should match what we used to generate our FBO attachments. For our ",e.exports.jsx(t.strong,{children:"screen"}),", we can use ",e.exports.jsx(t.code,{children:"size().height() * m_devicePixelRatio"})," instead."]}),`
`]})]}),`
...
realm!`}),`
`,e.exports.jsx(r,{images:[{src:"/labs/lab11/inverted_sphere.png",alt:"TODO"}],figNumber:9,targetWidth:"80%",figCaption:"Sphere w/ Phong Lighting + Invert Filter"}),`
