...
`]}),`
`,e.exports.jsx(t.p,{children:"Be aware, in this lab you will not be able to see any visual output until you complete the final drawing section!"}),`
`,e.exports.jsx(t.h2,{id:"intro",children:e.exports.jsx(t.a,{href:"#intro",children:"Intro"})}),`
`,e.exports.jsxs(t.p,{children:["Currently, our data is stored in C++ structures on the ",e.exports.jsx(t.em,{children:"CPU"}),`, but in this lab you will create OpenGL specific objects to both store and describe the data that
...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/VBO_VAO_Overview.png",alt:"TODO"}],figNumber:2,targetWidth:"95%",figCaption:"Visualization of VBOs and VAOs"}),`
`,e.exports.jsx(t.p,{children:`At the moment, you can imagine a VBO to be a dumb container, the same as a C++
...
this array contains metadata about where this attribute is located in the VBO.`]}),`
...
`,e.exports.jsxs(t.p,{children:[`The home page for OpenGL 3.1 is located
`,e.exports.jsx(t.a,{href:"https://registry.khronos.org/OpenGL-Refpages/es3.1/",target:"_blank",rel:"noopener noreferrer",children:"here"}),"."]}),`
`,e.exports.jsx(t.p,{children:`While our projects are set up to use OpenGL 4.1, the functions we will be using
...
`,e.exports.jsxs(t.p,{children:["Notice the different sections. The first section, ",e.exports.jsx(t.strong,{children:"Name"}),`, says the function name along
...
`,e.exports.jsxs(t.p,{children:[`In cases where a function has input parameters, there will be an intermediate section
titled `,e.exports.jsx(t.strong,{children:"Parameters"}),` which gives short descriptions of each input parameter and occasionally
what values they can take on.`]}),`
`,e.exports.jsxs(t.p,{children:["The third section, ",e.exports.jsx(t.strong,{children:"Description"}),`, gives you much more information about how the function
is used and sometimes information about the parameters in question such as OpenGL error
enums as we see here!`]}),`
`,e.exports.jsxs(t.p,{children:["The fourth section, ",e.exports.jsx(t.strong,{children:"API Version Support"}),`, tells us in which OpenGL versions this function
...
`,e.exports.jsx(t.p,{children:`Through this lab and your work in OpenGL, we strongly recommend having the docs open in
...
`,e.exports.jsxs(t.p,{children:["For this section, you will be working in ",e.exports.jsx(t.code,{children:"debug.h"}),`. However, for the rest of the assignment,
you will be working in `,e.exports.jsx(t.code,{children:"glRenderer.cpp"}),"."]}),`
`]}),`
`,e.exports.jsx(t.p,{children:`Any time OpenGL is incorrectly used, instead of crashing the program, you
may just encounter a blank screen with no error messages. This may be difficult to debug,
but luckily, OpenGL does some work behind the scenes for us.`}),`
`,e.exports.jsx(t.p,{children:`Each time OpenGL detects a function has been used incorrectly, it will set an error flag
behind the scenes. But how do we know what error flags are currently set? In the previous section,
you looked at the documentation for a function called glGetError. This function when called
will return one of these stored error flags and clear it from storage. Unfortunately, the
order in which flags are returned is random, so the best way to overcome this is if
you encounter errors, check the flags, and check them often.`}),`
...
`,e.exports.jsx(t.pre,{children:e.exports.jsxs(t.code,{className:"code-highlight",children:[e.exports.jsx(t.span,{className:"code-line",children:`inline void checkOpenGLErrors(){
...
`})]})}),`
`,e.exports.jsxs(t.blockquote,{children:[`
`,e.exports.jsxs(t.p,{children:[`Feel free to use this header file in your OpenGL projects. You are not expected to understand
`,e.exports.jsx(t.strong,{children:"namespace"})," and ",e.exports.jsx(t.strong,{children:"inline"}),`, but just know to use this function in another file, be sure to
include the header file and call the function as: `,e.exports.jsx(t.code,{children:"Debug::checkOpenGLErrors()"}),"."]}),`
`]}),`
`,e.exports.jsx(t.p,{children:`While this is useful, sometimes if we are calling this multiple times in different locations
throught our program, it can be difficult to determine which call is reading in an error.`}),`
`,e.exports.jsx(t.p,{children:`How about we change our function to take in a line number and file name so we can use that
when we print our errors:`}),`
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["Add two input parameters to the ",e.exports.jsx(t.code,{children:"checkOpenGLErrors"}),` function, the first being a
`,e.exports.jsx(t.code,{children:"const char*"})," for the file name, and the second being an ",e.exports.jsx(t.code,{children:"int"}),` for the line number. Edit the print
statement to include this information to make the debug statements more descriptive.`]})}),`
`,e.exports.jsx(t.p,{children:`This is great, but a pain to input the file and line every time we call the function.
Luckily, C++ provides preprocessor macros: __LINE__ and __FILE__ which get replaced at
...
`,e.exports.jsx(t.pre,{children:e.exports.jsx(t.code,{className:"code-highlight",children:e.exports.jsx(t.span,{className:"code-line",children:`  Debug::checkOpenGLErrors(__FILE__, __LINE__);
`})})}),`
`,e.exports.jsxs(t.p,{children:["We can make this even simpler by using something called a ",e.exports.jsx(t.strong,{children:"preprocessor directive"}),`.
A preprocessor directive is indicated by the use of a hash symbol in the beginning. As a matter
of fact, you may already be familiar with the `,e.exports.jsx(t.strong,{children:"#include"})," preprocessor directive."]}),`
`,e.exports.jsxs(t.p,{children:["The one we will be using is: ",e.exports.jsx(t.strong,{children:"#define"}),". This has a signature of:"]}),`
`,e.exports.jsx(t.pre,{children:e.exports.jsx(t.code,{className:"code-highlight",children:e.exports.jsx(t.span,{className:"code-line",children:`#define identifier replacement
`})})}),`
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsx(t.p,{children:"After defining our 'checkOpenGLErrors' function, add the following preprocessor directive:"}),e.exports.jsx(t.pre,{children:e.exports.jsx(t.code,{className:"code-highlight",children:e.exports.jsx(t.span,{className:"code-line",children:`#define checkOpenGLErrors() checkOpenGLErrors(__FILE__, __LINE__)
`})})})]}),`
`,e.exports.jsx(t.p,{children:`Now we can call the function with no arguments, just as we did originally but the preprocessor
...
`,e.exports.jsxs(t.p,{children:[`Instead of defining a bunch of instances of objects and calling functions on them directly,
OpenGL functions as a `,e.exports.jsx(t.strong,{children:"state machine"}),`. This means that you keep track of some overarching
...
`,e.exports.jsxs(t.ol,{children:[`
`,e.exports.jsxs(t.li,{children:[e.exports.jsx(t.strong,{children:"Assume Nothing"}),`. When writing a function that uses OpenGL, consider that the state could
be anything. Explicitly set the values of the state parameters you depend on.`]}),`
`,e.exports.jsxs(t.li,{children:[e.exports.jsx(t.strong,{children:"Default Configuration"}),`. Decide on a set of reasonable default state values, and set the
...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/State_Machine.png",alt:"TODO"}],figNumber:3,targetWidth:"95%",figCaption:"Visualization of OpenGL State Machine"}),`
`,e.exports.jsxs(t.blockquote,{children:[`
`,e.exports.jsxs(t.p,{children:["Note: Through the rest of this lab, you will be working in the ",e.exports.jsx(t.code,{children:"glRenderer.cpp"})," file!"]}),`
`]}),`
...
`,e.exports.jsx(t.p,{children:`Typically, shapes in OpenGL are broken down into a collection of triangles, each of which
...
`,e.exports.jsxs(t.p,{children:[`To send this data, we need some sort of container or buffer to store it first. In
OpenGL, this generic container is called a `,e.exports.jsx(t.strong,{children:"Vertex Buffer Object"}),", or ",e.exports.jsx(t.strong,{children:"VBO"}),` for short.
...
following function useful:`]}),e.exports.jsxs(t.div,{className:"success-callout callout",children:[e.exports.jsx("p",{style:{textAlign:"center"},children:e.exports.jsxs(t.blockquote,{children:[`
...
`]})}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"n"})," :"]}),` This indicates the number of vertex buffer objects to create.
The type GLsizei is an OpenGL alias indicating it is an integer representing some size`]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"buffers"})," :"]}),` This is the pointer this function will fill in with an id for the
...
`,e.exports.jsxs(t.p,{children:[`But before we do this, we actually need some data to put inside. Let\u2019s construct
an `,e.exports.jsx(t.code,{children:"std::vector"})," that represents a triangle."]}),`
...
`,e.exports.jsx(t.p,{children:`A triangle as said before is defined by 3 vertices. For now, let's assume that these
...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/openglcoordinates.png",alt:"TODO"}],figNumber:4,targetWidth:"95%",figCaption:"OpenGL Coordinate System"}),`
...
`,e.exports.jsxs(t.p,{children:[`Lets take a closer look at the data parameter. The function expects a pointer to an input data array,
but we don't have that array yet! Let's use an `,e.exports.jsx(t.code,{children:"std::vector"}),` to construct our
...
`,e.exports.jsx(t.div,{className:"task-callout callout",children:e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"initializeGL"}),", construct an ",e.exports.jsx(t.code,{children:"std::vector"}),` containing your three triangle points in a contiguous
series of floats.`]})}),`
`,e.exports.jsxs(t.p,{children:["Now to pass this into the function, we can use the ",e.exports.jsx(t.code,{children:"data()"})," method of the ",e.exports.jsx(t.code,{children:"std::vector"}),`
object. This will return a pointer to the first element as needed.`]}),`
`,e.exports.jsx(t.p,{children:`For the size, while we can manually input the size of our data, it is much easier
...
`,e.exports.jsxs(t.p,{children:["To get the first part is simple using ",e.exports.jsx(t.code,{children:"std::vector"}),` methods. For the second part,
...
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"initializeGL"}),", generate a single VAO and store its id in ",e.exports.jsx(t.code,{children:"m_vao"}),`. You may find the
following function useful:`]}),e.exports.jsxs(t.div,{className:"success-callout callout",children:[e.exports.jsx("p",{style:{textAlign:"center"},children:e.exports.jsxs(t.blockquote,{children:[`
...
`]})}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"n"})," :"]})," This indicates the number of vertex array objects to create."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"arrays"})," :"]}),` This is the pointer this function will fill in with an id
...
`,e.exports.jsx(t.p,{children:"Next to actually use this VAO, we need to bind it to the state."}),`
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In ",e.exports.jsx(t.code,{children:"initializeGL"}),", bind your VAO. You may find the following function useful:"]}),e.exports.jsxs(t.div,{className:"success-callout callout",children:[e.exports.jsx("p",{style:{textAlign:"center"},children:e.exports.jsxs(t.blockquote,{children:[`
...
`]})}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"array"})," :"]})," This is the id of the VAO we wish to bind"]})]})]}),`
...
we use to identify each attribute. We pick this value ourselves and in the next lab, Shaders,
you will see how we use this index when doing shader programming! Because we have written
...
`]})}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"index"})," :"]})," This is the same index as used in ",e.exports.jsx(t.code,{children:"glEnableVertexAttribArray"})," above."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"size"})," :"]}),` This indicates the length of one vertex's instance of this attribute,
not the size in bytes. For a position of 3 floats, this would simply be 3. For
an attribute that has 5 ints, this would be 5.`]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"type"})," :"]}),` This indicates the type of variable used for each component in the
attribute. For floats, this would be `,e.exports.jsx(t.code,{children:"GL_FLOAT"}),"."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"normalized"})," :"]})," This is a bit complicated to do with types, but for now use ",e.exports.jsx(t.code,{children:"GL_FALSE"}),"."]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"stride"})," :"]}),` This indicates the size in bytes between two vertices.
That is, the distance between the x coordinate of the position of the first vertex
and the x coordinate of the second vertex in bytes would be this value`]}),e.exports.jsxs(t.p,{children:[e.exports.jsxs(t.strong,{children:[e.exports.jsx(t.code,{children:"pointer"})," :"]}),` This is a pointer to the first vertex's instance of the attribute
...
`,e.exports.jsx(t.code,{children:"reinterpret_cast<void*>(offset value)"})]}),e.exports.jsx(s,{images:[{src:"/labs/lab9/Stride_Offset_White_Background.png",alt:"TODO"}],figNumber:5,targetWidth:"95%",figCaption:"Visualization of Vertex Attribute layouts"})]}),`
`,e.exports.jsxs(t.blockquote,{children:[`
...
in figure 5 below!`}),`
`]}),`
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/VAOMultiple.png",alt:"TODO"}],figNumber:6,targetWidth:"80%",figCaption:"VAOs w/ Single and Multiple VBOs"}),`
...
`]}),`
`,e.exports.jsx(t.p,{children:`For this, you will only be responsible for steps 1 and 2.b.i through 2.b.iii. Since we only
will be using a single shader and a single VAO, we can collapse this into a linear set
of steps.`}),`
...
`,e.exports.jsxs(t.p,{children:["Now let's actually ",e.exports.jsx(t.em,{children:"draw"})," our VAOs."]}),`
`,e.exports.jsxs(t.div,{className:"task-callout callout",children:[e.exports.jsxs(t.p,{children:["In the middle of ",e.exports.jsx(t.code,{children:"paintGL"}),", draw our triangle. You may find the following useful:"]}),e.exports.jsxs(t.div,{className:"success-callout callout",children:[e.exports.jsx("p",{style:{textAlign:"center"},children:e.exports.jsxs(t.blockquote,{children:[`
...
`,e.exports.jsx(s,{images:[{src:"/labs/lab9/FinalTriangle.png",alt:"TODO"}],figNumber:7,targetWidth:"95%",figCaption:"Colorful Triangle"}),`
...
to store our data and objects. This memory is `,e.exports.jsx(t.strong,{children:"not"}),`
...
`,e.exports.jsxs(t.p,{children:["For now we will use two, ",e.exports.jsx(t.a,{href:"https://registry.khronos.org/OpenGL-Refpages/es3.1/html/glDeleteBuffers.xhtml",target:"_blank",rel:"noopener noreferrer",children:"glDeleteBuffers"}),`
which applies to VBOs, and `,e.exports.jsx(t.a,{href:"https://registry.khronos.org/OpenGL-Refpages/es3.1/html/glDeleteVertexArrays.xhtml",target:"_blank",rel:"noopener noreferrer",children:"glDeleteVertexArrays"}),`
...
`,e.exports.jsx(t.p,{children:"Congrats on finishing the VBOs & VAOs lab! Now, it's time to get checked off by a TA."}),`
`,e.exports.jsx(t.h2,{id:"submission",children:e.exports.jsx(t.a,{href:"#submission",children:"Submission"})}),`
`,e.exports.jsxs(t.p,{children:[`Submit your Github repo for this lab to the "Lab 09: VBOs & VAOs" assignment on Gradescope, then get checked off by a TA during lab hours.
