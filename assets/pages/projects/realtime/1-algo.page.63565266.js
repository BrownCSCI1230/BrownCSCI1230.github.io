...
`,e.exports.jsx(s.pre,{children:e.exports.jsxs(s.code,{className:"code-highlight",children:[e.exports.jsx(s.span,{className:"code-line",children:`	create vbo\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`	bind vbo\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`	fill vbo with data\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`	unbind vbo\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`	create vao\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`	bind vao\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`	set vao attributes\r
`}),e.exports.jsx(s.span,{className:"code-line",children:`	unbind vao
`})]})}),`
`,e.exports.jsx(s.p,{children:`What would be the issue if a student tries to draw their vao in paintGL?\r
...
`,e.exports.jsx(s.pre,{className:"language-cpp",children:e.exports.jsxs(s.code,{className:"language-cpp code-highlight",children:[e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-en",children:"glEnableVertexAttribArray"}),"(",e.exports.jsx(s.span,{className:"pl-c1",children:"0"}),`);\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-en",children:"glEnableVertexAttribArray"}),"(",e.exports.jsx(s.span,{className:"pl-c1",children:"1"}),`);\r
`]}),e.exports.jsxs(s.span,{className:"code-line",children:[e.exports.jsx(s.span,{className:"pl-en",children:"glVertexAttribPointer"}),"(",e.exports.jsx(s.span,{className:"pl-c1",children:"0"}),", ",e.exports.jsx(s.span,{className:"pl-c1",children:"3"}),", GL_FLOAT, GL_FALSE, ",e.exports.jsx(s.span,{className:"pl-c1",children:"6"})," * ",e.exports.jsx(s.span,{className:"pl-k",children:"sizeof"}),`(GLfloat), nullptr);\r
...
`})]})]})}function x(t={}){const{wrapper:s}=t.components||{};return s?e.exports.jsx(s,Object.assign({},t,{children:e.exports.jsx(r,t)})):r(t)}export{x as default,c as documentProps};
