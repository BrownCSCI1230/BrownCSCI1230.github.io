...
`,e.exports.jsx(t.p,{children:`You may notice that your outputs have "jaggies" on edges like the image shown below.\r
...
`,e.exports.jsxs(t.p,{children:["For the scope of this assignment, ",e.exports.jsx(t.strong,{children:"color the pixel with the WORLD SPACE normal of the primitive at the intersection point"}),`.\r
You may have noticed that the value of normal ranges from -1 to 1, but RGB color only ranges from 0 to 1. Hence, a mapping is required to convert the value.\r
