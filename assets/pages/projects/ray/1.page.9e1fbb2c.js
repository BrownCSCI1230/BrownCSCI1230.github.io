...
`]}),`
`,e.exports.jsxs(t.li,{children:[`
`,e.exports.jsxs(t.p,{children:[e.exports.jsx(t.strong,{children:"Parallelization"}),`:
There are many ways to parallelize your code. It can be as simple as one line of code in OpenMP.
It can also go up to a carefully designed task scheduler that acts like Cinebench.
Evidently, the grades you receive will be based on the complexity of your implementation.
...
`]}),`
`,e.exports.jsxs(t.li,{children:[`
`,e.exports.jsxs(t.p,{children:[e.exports.jsx(t.strong,{children:"Anti-aliasing (3pts)"}),`:
As we are only shooting one ray through the center of each pixel, it can be expected that there will be aliasing.
In your filter project, you\u2019ve learnt some ways to fix aliasing as a post-processing approach.
...
`]}),`
`,e.exports.jsxs(t.li,{children:[`
`,e.exports.jsxs(t.p,{children:[e.exports.jsx(t.strong,{children:"Super-sampling"}),`:
As mentioned above, the source of aliasing is the low number of samples.
